...
class PluginLoader(object):
    ...
    def register_plugins(self):
        ...
        for id in self.plugin_infos:
            try:
                ...
                data_dir = os.path.abspath(os.path.join('data', id))
    ...
    def get_plugin_list(self):
        return {"infos": self.plugin_infos, "methods": self.plugin_methods, "registers": self.plugin_registers,
                "enables": self.plugin_enables, "commands": self.plugin_commands, "auths": self.plugin_auths}
